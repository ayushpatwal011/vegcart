    ...
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
      ...
      <div className="hidden sm:flex items-center gap-8 text-md">
        ...
        {!user ? (
          ...
          <div className="relative group">
            <img src={assets.profile_icon} alt="img" className="w-10" />
      ...
      {open && (
        <div
          className={`${
            open ? "flex" : "hidden"
          } absolute z-50 top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-md md:hidden`}
        >
          <NavLink to="/" onClick={() => setOpen(false)}>
            Home
          </NavLink>
